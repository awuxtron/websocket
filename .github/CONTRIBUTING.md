...
- Provide project and platform versions (os, php, etc), depending on what seems relevant.
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](../../). If you are looking for support, you
  might
...
This section guides you through submitting an enhancement suggestion for Test Project, **including completely new
...
- **Explain why this enhancement would be useful** to most Test Project users. You may also want to point out the other
...
- **Commit Messages**
    - All commit messages must be following rules
...
- **PSR-12 Coding Standard**
    - The easiest way to apply the conventions is to
      ...
      and [PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer).
